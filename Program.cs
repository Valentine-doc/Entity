...
namespace DBtest
{
    ...
    {
        static async Task Main(string[] args) //или void?..
        {
            if (args.Length == 0)
            {
                var s = new Server();
            ...
            {
                await Client.SendMsg(args[0]);  // но тогда как
            }
        }
        ...
        //    s.ProcessMessage(registerMessage, new IPEndPoint(IPAddress.Parse("127.0.0.1"), 5430));
        ...
        //    s.ProcessMessage(confirmationMessage, new IPEndPoint(IPAddress.Parse("127.0.0.1"), 5430));
        //}
        ...
        //        FromName = "User1",
        //        ToName = "User2",
        //        Text = "Пробное сообщение..."
        //    };
        //    //Отправляем тестовое сообщение на сревер для пересылки
        //    s.ProcessMessage(relayMessage, new IPEndPoint(IPAddress.Parse("127.0.0.1"), 5430));
        ...
        //    s.ProcessMessage(getUnreadMessages, new IPEndPoint(System.Net.IPAddress.Parse("127.0.0.1"), 5430));
        //}
    }
}
